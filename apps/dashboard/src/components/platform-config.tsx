...
> = {
  pagerduty: {
    ...
    icon: "PD",
    fields: [
      { key: "routingKey", label: "Routing Key", type: "secret", placeholder: "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" },
  ...
  jira: {
    ...
    icon: "JR",
    fields: [
      { key: "baseUrl", label: "Base URL", type: "string", placeholder: "https://yourcompany.atlassian.net" },
      { key: "projectKey", label: "Project Key", type: "string", placeholder: "OPS" },
      { key: "issueType", label: "Issue Type", type: "string", placeholder: "Bug" },
      { key: "userEmail", label: "User Email", type: "string", placeholder: "sre@company.com" },
      { key: "apiToken", label: "API Token", type: "secret", placeholder: "ATATT3x..." },
    ],
  },
  servicenow: {
    label: "ServiceNow",
    icon: "SN",
    fields: [
      { key: "instanceUrl", label: "Instance URL", type: "string", placeholder: "https://your-instance.service-now.com" },
      { key: "table", label: "Table", type: "string", placeholder: "incident" },
      { key: "username", label: "Username", type: "string", placeholder: "admin" },
  ...
  slack: {
    ...
    icon: "SK",
    fields: [
      { key: "webhookUrl", label: "Webhook URL", type: "secret", placeholder: "https://hooks.slack.com/services/..." },
    ...
    <div className="rounded-2xl bg-white shadow-[0_1px_3px_rgba(0,0,0,0.06),0_1px_2px_rgba(0,0,0,0.04)]">
      ...
      <div className="divide-y divide-[#f2f2f7]">
        {Object.entries(PLATFORM_DEFS).map(([key, def]) => {
          ...
          const hasConfig = def.fields.some(
            (f) => !!cfg[f.key] && cfg[f.key] !== "****",
          );
